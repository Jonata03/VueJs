...
<script>
import elementoMixin from "./desafioMixin"
export default {
  mixins:[elementoMixin],
	filters:{
    separador(valor){
  ...
  data(){
    return{
      frase: "fullstack developer python java cobol e etc"
    }
  },
  computed:{
    elemento(){
